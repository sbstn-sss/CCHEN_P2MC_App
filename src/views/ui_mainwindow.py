...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.timer_widget = QtWidgets.QWidget(self.centralwidget)
        self.timer_widget.setObjectName("timer_widget")
        self.graph_layout.addWidget(self.timer_widget)
        ...
        self.channels_out_layout.addWidget(self.label_24)
        ...
        self.channels_out_layout.addLayout(self.temp_q_grid)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_24.setText(_translate("MainWindow", "Canales:"))
